	...
	return (
		...
		>
			...
			<div className={clsx("flex flex-1 flex-col p-8 transition-colors group-hover:bg-gray-50 dark:group-hover:bg-gray-700/50", isPurpleBackground ? "" : "border-2 border-t-0 border-background dark:border-gray-700 bg-white dark:bg-gray-800")}>
				<h2 className={clsx("mt-1 text-2xl font-medium transition-colors group-hover:text-highlight-light dark:group-hover:text-secondary", isPurpleBackground ? "" : "dark:text-white")}>{item.fields.title}</h2>
				...
				<div
					className={clsx(
						...
						isPurpleBackground
							? ""
							: "text-highlight-dark dark:text-secondary transition-colors group-hover:text-highlight-light dark:group-hover:text-secondary"
					)}
				>
					Read More
					<IconChevronRight size={18} stroke={2} />
