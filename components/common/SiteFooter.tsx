...
const SiteFooter = () => {
	...
	const socials = [
		{
			...
			icon: <IconBrandX className="text-xl md:ml-8 text-primary-500 hover:text-primary-700 transition duration-300" />,
		},
		{
			title: "Instagram",
			url: "https://www.instagram.com/agilitycms",
			icon: (
				<IconBrandInstagram className="text-xl md:ml-8 text-primary-500 hover:text-primary-700 transition duration-300" />
			),
		},
		{
			title: "Slack",
			...
			icon: (
				<IconBrandSlack className="text-xl md:ml-8 text-primary-500 hover:text-primary-700 transition duration-300" />
			),
		},
		{
			title: "YouTube",
			...
			icon: (
				<IconBrandYoutube className="text-xl md:ml-8 text-primary-500 hover:text-primary-700 transition duration-300" />
			),
		},
	]
	...
	return (
		<footer className="">
			<div className="px-8 py-6 md:py-4 mt-8 bg-highlight-light">
			...
			<div className="bg-highlight-dark text-white">
				<div className="max-w-screen-xl mx-auto md:flex md:items-center">
					XXX
